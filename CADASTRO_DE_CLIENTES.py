...
def XRISTE(FILE):
    ...
    sao tuplas com a senha de usuario e o nivel do usuario.
    A origem do nome vem do catolicismo - Cristo - em grego.
    Nome singular para confundir possiveis hackers.
    Ex.: XRISTE(String)
    '''
    u = ""
    p = ""
...
def ELEISSON(DIC3):
    ...
    tuplas independentemente do tamanho da tupla e os transforma numa string criptografada 
    formada por codigos ASCII acrescidos de + 37 e cujo separador e codigo 254 + 37 = 291.
    A origem do nome vem do catolicismo - Eleisson significa 'perdao' em grego.
    Nome singular para confundir possiveis hackers.
...
def CHRISTUS(FILE):
    ...
    tuplas com todos os dados de cliente: Nome Fantasia, Razao Social, Endereco, Telefone, Contato,
    endereco, Cidade, Estado, CEP, Equipamento, Numero de Serie.
    A origem do nome vem do catolicismo - Cristo - em latim.
    Nome singular para confundir possiveis hackers.
...
def Mai_Min(entrada,compare):
    ...
    ambos e as compara como iguais ou nao. Se forem de mesmo tamanho e houver congruencia
    de caracteres minusculos e maiusculos, retorna True. Senão retorna False.

    Ex.: Mai_Min(String1,String2)
    '''
    Lord1 = []
    Lord2 = []
    cont = 0
    ...
    if (User_OK == True):
        ...
        while (Menu_Loop == True):
            if (User_Power == 4) or (User_Power == 3):
                ...
                print("4 - GERA ARQUIVO DE CLIENTES")
                print("5 - CONSULTA LOG")
                print("6 - LOGOUT")
            ...
            if (oPtion != "1") and (oPtion != "2") and (oPtion != "3") and (oPtion != "4") and (oPtion != "5") and (oPtion != "6") and (oPtion != "sair"):
                Menu_Loop = True
            ...
            if (oPtion == "1"):
                ...
                while (lcr == True):
                    if (User_Power == 4) or (User_Power == 3):
                        ...
                        print("11 - CADASTRAR NOVO USUÁRIO")
                        print("12 - ALTERAR SENHA")
                        print("13 - REMOVER USUÁRIO")
                        print("14 - MOSTRAR USUÁRIOS")
                        if (User_Power == 4):
                            print("15 - ALTERAR NÍVEL DE USUÁRIO")
                        print("sair - SAIR")
                        for line in range(4):
                            print("\n")                        
                    CR_oPtion = str(input("Digite a opção:"))
                    ...
                    #REMOVER USUARIO
                    if (CR_oPtion == "13") and ((User_Power == 4) or (User_Power == 3)):
                        delly = True
                        while (delly == True):
                    ...
                    #ALTERAR SENHA
                    if (CR_oPtion == "12") and ((User_Power == 4) or (User_Power == 3)):
                        las = True
                        while (las == True):
                                ...
                                if (Pass_User_Change in User_Dic) and (Pass_User_Change != "adm") and (Pass_User_Change != User_Current):
                                    ...
                                    while (ll == True):
                                        ...
                                        if (oppsw == "N") or (oppsw == "n"):
                                            ...
                                            las = False
                                            lcr = True
                                if (Pass_User_Change not in User_Dic):
                                    print ("Usuário inexistente!"+"\n")
                                    las = True

                    #ALTERAR NIVEL USUARIO
                    if (CR_oPtion == "15") and (User_Power == 4):
                        lnv = True
                        while (lnv == True):
                    ...
                    #CONSULTA USUARIOS
                    if (CR_oPtion == "14") and ((User_Power == 4) or (User_Power == 3)):
                    ...
                    if (CR_oPtion != "11") and (CR_oPtion != "12") and (CR_oPtion != "13") and (CR_oPtion != "14") and (CR_oPtion != "15") and (CR_oPtion != "sair"):
                        lcr = True
                        print("Opção inválida!"+"\n")
            
            #CADASTRO DE CLIENTES
            if (oPtion == "2") and (User_Power != 1):
                cc_Loop = True
                while (cc_Loop == True):
                    for line in range(4):
                        print("\n")
                    print("***CADASTRO DE CLIENTES***"+"\n")
                    print("21 - CADASTRAR NOVO CLIENTE")
                    print("22 - ALTERAR DADOS DE CLIENTE")
                    print("23 - REMOVER CLIENTE")
                    print("sair - SAIR")
                    for line in range(4):
                        print("\n")
                    CC_oPtion = str(input("Digite a opção:"))
                    if (CC_oPtion == "sair"):
                        cc_Loop = False
                    if (CC_oPtion != "21") and (CC_oPtion != "22") and (CC_oPtion != "23") and (CC_oPtion != "sair"):
                        cc_Loop = True
            ...
            if (oPtion == "3"):
                ...
                while (CL_Loop == True):
                    ...
                    print("31 - Código de Cliente")
                    print("32 - Nome Fantasia")
                    print("33 - Cidade")
                    print("34 - Estado")
                    print("35 - Todos os clientes")
                    print("sair - SAIR")
                    for line in range(3):
                        print("\n")
                    CL_oPtion = str(input("Digite a opção:"))
                    if (CL_oPtion == "sair"):
                        CL_Loop = False
                        
                    if (CL_oPtion != "31") and (CL_oPtion != "32") and (CL_oPtion != "33") and (CL_oPtion != "34") and (CL_oPtion != "35") and (CL_oPtion != "sair"):
                        print("Opção inválida!"+"\n")
                        CL_Loop = True
            ...
            #CONSULTA LOG
            if (oPtion == "5") and ((User_Power == 4) or (User_Power == 3)):
                loop_Log = True
                while (loop_Log == True):
                    for line in range(4):
                        print("\n")
                    print("***Consulta Log***"+"\n")
                    print("51 - Consultar por usuário")
                    print("52 - Consultar por data")
                    print("sair - Sair")
                    for line in range(4):
                        print("\n")
                    oPlog = str(input("Digite a opção:"))
                    if (oPlog == "sair"):
                        loop_Log = False
                    else:
                        if (oPlog != "51") and (oPlog != "52") and (oPlog != "sair"):
                            loop_Log = True
                            print("Opção inválida!"+"\n")
                        if (oPlog == "51"):
                            loop_user_log = True
                            while (loop_user_log == True):
                                ...
                                if (usrr in User_Dic):
                                    ...
                                    Log_List.append(Log_Occur)
                                    Log_Exit = str(input("Lista de Log mostrada. Deseja encerrar? (s/n)"))
                                    if (Log_Exit == "s") or (Log_Exit == "S"):
                                        loop_user_log = False
                                        loop_Log = False
                                    if (Log_Exit == "n") or (Log_Exit == "N"):
                                        loop_Log = True
                                    if (Log_Exit == "s") and (Log_Exit == "S") and (Log_Exit == "n") and (Log_Exit == "N"):
                                        loop_Log = True

                        if (oPlog == "52"):
                            loop_Date_log = True
                            while (loop_Date_log == True):
                                print("\n"+"Favor não digitar o número '0' antes do Dia, Mês ou Ano."+"\n")
